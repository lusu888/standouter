...
@property (nonatomic, getter = willshow) BOOL *willshow;
@property (nonatomic, assign) int videoidno;
@property (nonatomic, assign) int ownerid;
@property (nonatomic, assign)  NSString *videotitle;
@property(nonatomic,assign) NSDictionary *resultJSON;
-(void)hengtableinit;
